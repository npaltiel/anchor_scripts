...
earliest_start_date = invoiced_visits.groupby(['Admission ID']).agg({
...
latest_info = latest_info.groupby(['Medicaid Number']).agg({
...
team_hours_report = team_billed_hours.groupby(['Team', 'Medicaid Number', 'Contract', 'County', 'Patient Start Date'])[
